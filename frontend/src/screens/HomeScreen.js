...
function HomeScreen(props) {
    ...
    const submitSignUp = async() =>{
        ...
        const {response} = await axios.post('https://frontend1-jf4tb7oer-anaiturbec.vercel.app/users/signup', body, {
    ...
    const submitProduct = async() =>{
        ...
        const {response} = await axios.post('https://frontend1-jf4tb7oer-anaiturbec.vercel.app/products/register', body, {
            headers: {'content-type': 'application/json' }
        });
        console.log(response);
    ...
    const submitSignIn = async() =>{
        ...
        const {response} = await axios.post('https://frontend1-jf4tb7oer-anaiturbec.vercel.app/users/signin', body, {
            headers: {'content-type': 'application/json' }
        });
        console.log(response);
        navigate('/vote');
