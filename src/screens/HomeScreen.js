...
function HomeScreen(props) {
    ...
    const submitSignUp = async() =>{
        ...
        const {response} = await axios.post('https://rocky-basin-03613.herokuapp.com/https://backendph2.herokuapp.com/users/signup', body, {
    ...
    const submitProduct = async() =>{
        ...
        const {response} = await axios.post('https://rocky-basin-03613.herokuapp.com/https://backendph2.herokuapp.com/products/register', body, {
            headers: {'content-type': 'application/json' }
        });
        console.log(response);
    ...
    const submitSignIn = async() =>{
        ...
        const {response} = await axios.post('https://rocky-basin-03613.herokuapp.com/https://backendph2.herokuapp.com/users/signin', body, {
            headers: {'content-type': 'application/json' }
        });
        console.log(response);
        navigate('/vote');
